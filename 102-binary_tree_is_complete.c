...
/**
 * create_node - Create a new levelorder_queue_t node.
 *
 * @node: Binary tree node to be stored in the new node.
 *
 * Return: NULL if error, Otherwise, ptr to the new node.
 */
levelorder_queue_t *create_node(binary_tree_t *node)
{
 ...
 * @tail: A double ptr to the tail of the queue.
 *
...
/**
 * pop - Pops the head of a levelorder_queue_t.
 * @head: A double ptr to the head of the queue.
 */
void pop(levelorder_queue_t **head)
{
 ...
 *
 * Description: exits status code of 1 upon malloc failure
 */
