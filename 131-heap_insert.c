 ...
 * Return: no of descendant child nodes
 */
...
/**
 * insert - func to insert node to correct location
 * @root: A double ptr to root of max heap
 ...
 * @root: A double ptrto root of tree
 * @value: input value
